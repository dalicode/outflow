  ...
  return (
    <main className="max-w-4xl mx-auto px-4 py-6 space-y-6">
      <div className="grid sm:grid-cols-2 gap-4">
        <section className="bg-white dark:bg-gray-800 rounded-theme-large shadow-sm p-5 card-theme">
      ...
      <section className="bg-white dark:bg-gray-800 rounded-theme-large shadow-sm p-5 card-theme">
        <FixedExpensesList items={fixedExpenses} onAdd={handleAddFixed} onUpdate={handleUpdateFixed} onDelete={handleDeleteFixed} />
      </section>
      <section className="bg-white dark:bg-gray-800 rounded-theme-large shadow-sm p-5 card-theme">
        <SummarySection monthlyIncome={monthlyIncome} totalFixed={totalFixed} variableExpenses={variableExpenses} savingsRate={savingsRate} />
      </section>
      <section className="bg-white dark:bg-gray-800 rounded-theme-large shadow-sm p-5 card-theme">
        <ChartComponent totalFixed={totalFixed} variableExpenses={variableExpenses} savings={savings} />
      </section>
    </main>
  )
}
