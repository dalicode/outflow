...
export function useDashboardData(
  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      const allSnapshotsByYear: Record<number, Awaited<ReturnType<typeof StorageService.getSnapshotsForYear>>> = {};
      const incomeSnapsByYear: Record<number, Awaited<ReturnType<typeof StorageService.getIncomeSnapshotsForYear>>> = {};
      const savingsSnapsByYear: Record<number, Awaited<ReturnType<typeof StorageService.getSavingsSnapshotsForYear>>> = {};
    ...
    loadData();
  }, [selectedYear, selectedMonth, expenses, dataRefreshKey, monthSpan, monthKeys]);
