...
export const StorageService = {
  ...
  mergeCategory: async (sourceCategoryId: number, targetCategoryId: number): Promise<void> => {
  ...
  mergePayee: async (sourcePayeeId: number, targetPayeeId: number): Promise<void> => {
