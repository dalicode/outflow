...
export function getFilteredOptions<T extends ComboboxOption>(options: T[], query: string): T[] {
...
export function hasExactMatch(options: Array<{ label: string }>, query: string): boolean {
  const q = normalizeSearchText(query)
