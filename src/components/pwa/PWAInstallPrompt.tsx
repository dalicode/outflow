            ...
            <div className="flex items-center gap-3 min-w-0">
              ...
              <div className="min-w-0">
                ...
                <p className="text-xs text-theme-muted mt-0.5 leading-relaxed">
                  ...
                  {" "}then{" "}
                  <span className="font-medium text-theme-text">Add to Home Screen</span>
                </p>
              </div>
            </div>
            <button
    ...
    >
      <section className="pointer-events-auto w-full max-w-sm rounded-theme-large border border-theme-border bg-theme-surface px-4 py-3 shadow-lg">
        ...
        <div className="mt-3 flex gap-2">
          <button type="button" onClick={() => setDismissed(true)} className="btn-modal-cancel flex-1">
            Not now
          </button>
          <button type="button" onClick={() => void handleInstall()} className="btn-modal-primary flex-1">
            Install
          </button>
        </div>
      </section>
