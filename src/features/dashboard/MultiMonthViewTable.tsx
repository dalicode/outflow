                ...
                {monthSpan > 1 ? (
                  <>
                    ...
                    {[...monthSummaries]
                      ...
                      .map((summary, displayIdx) => {
                        const totalExpenses =
                          summary.fixedExpensesTotal + summary.variableExpenses;
                        return (
                          <td
                            key={displayIdx}
                            className={cn(
                      ...
                      <td
                        className={cn(
                          ...
                          monthSummaries.reduce(
                            (s, m) =>
                              s + m.fixedExpensesTotal + m.variableExpenses,
                            0,
                          ) < 0
                            ? "text-theme-success"
                            : "text-theme-danger",
                  ...
                  <>
                    ...
                    <td
                      className={cn(
                        "px-1.5 sm:px-2 md:px-3 py-1 text-right tabular-nums font-semibold",
                        monthSummaries[0].fixedExpensesTotal +
                          monthSummaries[0].variableExpenses <
                          0
                          ? "text-theme-success"
                          : "text-theme-danger",
                      )}
