...
import ExpenseEntityFields from './components/ExpenseEntityFields'
import ExpenseSplitSection, { type SplitChildDraft } from './components/ExpenseSplitSection'
import PayeeSuggestionBanner from './components/PayeeSuggestionBanner'
    ...
    <>
      ...
      >
        <form id="expense-form" onSubmit={submit} className="space-y-4" data-testid="expense-form">
          ...
          />
          <ExpenseSplitSection
            canToggleSplitMode={canToggleSplitMode}
            isSplitMode={isSplitMode}
            toggleSplitMode={toggleSplitMode}
            splitChildren={splitChildren}
            splitPayeeInheritanceLabel={splitPayeeInheritanceLabel}
            isLoadingSplit={isLoadingSplit}
            categoryOptions={categoryOptions}
            recentCategoryOptions={recentCategoryOptions}
            openSplitCategoryPickers={openSplitCategoryPickers}
            isMobileViewport={isMobileViewport}
            decimalPlaces={decimalPlaces}
            moneyConfig={moneyConfig}
            inputCls={inputCls}
            splitReconciliation={splitReconciliation}
            formatAmount={formatAmount}
            setOpenSplitCategoryPickers={setOpenSplitCategoryPickers}
            setSplitChildField={setSplitChildField}
            createCategory={createCategory}
            addSplitChild={addSplitChild}
            applyRemainingToChild={applyRemainingToChild}
            removeSplitChild={removeSplitChild}
          />
        </form>
      </Modal>
      <ConfirmDialog
