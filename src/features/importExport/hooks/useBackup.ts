...
export function useBackup({
  ...
  }, [backupPassword, passwordModalMode, user, rememberBackupPassword, pendingFile, replaceMode, onRefreshAll, triggerSync, triggerReload]);
  ...
  const handleBackupImport = useCallback(async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      const knownKeys = ["expenses", "categories", "fixedExpenses", "fixedExpenseSnapshots", "settings", "syncQueue"];
