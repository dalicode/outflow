...
describe('formatExpensesAsTsv', () => {
  it('exports a flat list that includes split child allocations and unsplit expenses', () => {
    const expenses: Expense[] = [
      { id: 11, splitId: 9, date: '2026-04-10', amount: 12, categoryId: 1, payeeId: 1, description: 'Food split' },
      { id: 12, splitId: 9, date: '2026-04-10', amount: 8, categoryId: 2, payeeId: 1, description: 'Taxi split' },
      { id: 13, date: '2026-04-11', amount: 4, categoryId: 1, payeeId: 2, description: 'Snack' },
    ]
